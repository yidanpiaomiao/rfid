...
.L19:
	.cfi_restore_state
	leaq	__PRETTY_FUNCTION__.26676(%rip), %rcx
	leaq	.LC3(%rip), %rsi
	leaq	.LC4(%rip), %rdi
	movl	$336, %edx
...
.L22:
	.cfi_restore_state
	leaq	__PRETTY_FUNCTION__.26692(%rip), %rcx
	leaq	.LC3(%rip), %rsi
	leaq	.LC7(%rip), %rdi
	movl	$365, %edx
	call	__assert_fail@PLT
...
.LHOTE9:
	.section	.rodata.__PRETTY_FUNCTION__.26692,"a",@progbits
	.align 8
	.type	__PRETTY_FUNCTION__.26692, @object
	.size	__PRETTY_FUNCTION__.26692, 15
__PRETTY_FUNCTION__.26692:
	.string	"p448_serialize"
	.section	.rodata.__PRETTY_FUNCTION__.26676,"a",@progbits
	.align 16
	.type	__PRETTY_FUNCTION__.26676, @object
	.size	__PRETTY_FUNCTION__.26676, 19
__PRETTY_FUNCTION__.26676:
